...
class Comment extends Component {
  ...
  deleteConfirmed = (comment) => {
    let answer = window.confirm("Are you sure you want to delete this comment?") //creates a popup window in the browser with "OK" or "cancel" as the two options
    if(answer) {
        ...
        <div className="col-md-12">
          ...
          <hr/>
            {comments.map((comment, i) => (
              <div key={i}> {/*used the curly brace for this function so we need to start it with return*/}
                  <div>
